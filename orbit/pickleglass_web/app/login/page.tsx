      ...
      if (user) {
        ...
        if (isElectronMode) {
          try {
            ...
            const deepLinkUrl = `paradoxeorbit://auth-success?` + new URLSearchParams({
              uid: user.uid,
              email: user.email || '',
            ...
            // setTimeout(() => {
            //   alert('Login completed. Please return to Paradoxe Orbit app.')
            // }, 1000)
...
<h1 className="text-3xl font-bold text-gray-900">Welcome to Paradoxe Orbit</h1>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200">
          ...
          <div className="mt-4 text-center">
            <button
              onClick={() => {
                if (isElectronMode) {
                  window.location.href = 'paradoxeorbit://auth-success?uid=default_user&email=contact@paradoxe.com&displayName=Default%20User'
                } else {
                  router.push('/settings')
                }
              }}
