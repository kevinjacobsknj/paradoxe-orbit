...
export class PermissionHeader extends LitElement {
    static styles = css`
        ...
        * {
        ...
        /* ────────────────[ GLASS BYPASS ]─────────────── */
        :host-context(body.has-orbit) .container,
        :host-context(body.has-orbit) .action-button,
        :host-context(body.has-orbit) .continue-button,
        ...
        :host-context(body.has-orbit) .container::after,
        :host-context(body.has-orbit) .action-button::after,
        :host-context(body.has-orbit) .continue-button::after {
            display: none !important;
        }

        :host-context(body.has-orbit) .action-button:hover,
        :host-context(body.has-orbit) .continue-button:hover,
