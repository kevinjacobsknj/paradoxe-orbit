...
export class MainHeader extends LitElement {
    ...
    static styles = css`
        ...
        * {
        ...
        /* ────────────────[ GLASS BYPASS ]─────────────── */
        :host-context(body.has-orbit) .header,
        :host-context(body.has-orbit) .listen-button,
        :host-context(body.has-orbit) .header-actions,
        :host-context(body.has-orbit) .settings-button,
        :host-context(body.has-orbit) .ask-input-container,
        :host-context(body.has-orbit) .ask-submit-button {
            background: transparent !important;
            filter: none !important;
            box-shadow: none !important;
            backdrop-filter: none !important;
        }
        :host-context(body.has-orbit) .icon-box {
            background: transparent !important;
            border: none !important;
        }

        :host-context(body.has-orbit) .header::before,
        :host-context(body.has-orbit) .header::after,
        :host-context(body.has-orbit) .listen-button::before,
        :host-context(body.has-orbit) .listen-button::after {
            display: none !important;
        }

        :host-context(body.has-orbit) .header-actions:hover,
        :host-context(body.has-orbit) .settings-button:hover,
        :host-context(body.has-orbit) .listen-button:hover::before {
            background: transparent !important;
        }
