...
export class SettingsView extends LitElement {
    static styles = css`
        * {
        ...
        :host-context(body.has-orbit) .settings-container::before {
                    ...
                    .map(([id, config]) => {
                        ...
                        <div class="provider-key-group">
                            ...
                            <input type="password" id="key-input-${id}"
                                placeholder=${loggedIn ? "Using Paradoxe's Key" : `Enter ${config.name} API Key`} 
                    ...
                    <div class="bottom-buttons">
                        ${this.firebaseUser
                            ? html`
                                ...
                                `
                            : html`
                                <button class="settings-button half-width" @click=${this.handleUseParadoxesKey}>
                                    <span>Login</span>
                                </button>
                                `
                        }
