...
.hljs-tag {
    color: #ff79c6 !important;
        ...
        /* ────────────────[ GLASS BYPASS ]─────────────── */
        :host-context(body.has-orbit) .assistant-container,
        :host-context(body.has-orbit) .top-bar,
        :host-context(body.has-orbit) .toggle-button,
        :host-context(body.has-orbit) .copy-button,
        :host-context(body.has-orbit) .transcription-container,
        :host-context(body.has-orbit) .insights-container,
        :host-context(body.has-orbit) .stt-message,
        :host-context(body.has-orbit) .outline-item,
        :host-context(body.has-orbit) .request-item,
        :host-context(body.has-orbit) .markdown-content,
        :host-context(body.has-orbit) .insights-container pre,
        :host-context(body.has-orbit) .insights-container p code,
        :host-context(body.has-orbit) .insights-container pre code {
            background: transparent !important;
        ...
        :host-context(body.has-orbit) .assistant-container::before,
        :host-context(body.has-orbit) .assistant-container::after {
            display: none !important;
        }

        :host-context(body.has-orbit) .toggle-button:hover,
        :host-context(body.has-orbit) .copy-button:hover,
        :host-context(body.has-orbit) .outline-item:hover,
        :host-context(body.has-orbit) .request-item.clickable:hover,
        :host-context(body.has-orbit) .markdown-content:hover {
            background: transparent !important;
            transform: none !important;
        }

        :host-context(body.has-orbit) .transcription-container::-webkit-scrollbar-track,
        :host-context(body.has-orbit) .transcription-container::-webkit-scrollbar-thumb,
        :host-context(body.has-orbit) .insights-container::-webkit-scrollbar-track,
        :host-context(body.has-orbit) .insights-container::-webkit-scrollbar-thumb {
            background: transparent !important;
        }
        :host-context(body.has-orbit) * {
        ...
        :host-context(body.has-orbit) ::-webkit-scrollbar,
        :host-context(body.has-orbit) ::-webkit-scrollbar-track,
        :host-context(body.has-orbit) ::-webkit-scrollbar-thumb {
            background: transparent !important;
