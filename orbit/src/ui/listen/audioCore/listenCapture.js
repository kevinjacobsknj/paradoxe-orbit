...
async function startCapture(screenshotIntervalSeconds = 5, imageQuality = 'medium') {
    ...
    try {
        ...
        // Note: paradoxeOrbit.e() is not available in this context, commenting out
        // paradoxeOrbit.e().setStatus('error');
    }
}
...
if (typeof window !== 'undefined') {
    ...
    window.paradoxeOrbit = window.paradoxeOrbit || {};
    window.paradoxeOrbit.startCapture = startCapture;
    window.paradoxeOrbit.stopCapture = stopCapture;
} 