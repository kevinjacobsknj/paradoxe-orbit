...
const openLoginPage = () => {
    const webUrl = process.env.paradoxeorbit_WEB_URL || 'http://localhost:3000';
        ...
        switch (name) {
            case 'listen': {
                ...
                if (!shouldUseLiquidGlass) {
                    ...
                    listenLoadOptions.query.orbit = 'true';
                    listen.loadFile(path.join(__dirname, '../ui/app/content.html'), listenLoadOptions);
            ...
            case 'ask': {
                ...
                if (!shouldUseLiquidGlass) {
                    ...
                    askLoadOptions.query.orbit = 'true';
                    ask.loadFile(path.join(__dirname, '../ui/app/content.html'), askLoadOptions);
            ...
            case 'settings': {
                ...
                if (!shouldUseLiquidGlass) {
                    ...
                    settingsLoadOptions.query.orbit = 'true';
                    settings.loadFile(path.join(__dirname,'../ui/app/content.html'), settingsLoadOptions)
                        .catch(console.error);
