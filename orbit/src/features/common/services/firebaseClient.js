...
const firebaseConfig = {
    ...
    authDomain: 'paradoxe-3651a.firebaseapp.com',
    projectId: 'paradoxe-3651a',
    storageBucket: 'paradoxe-3651a.firebasestorage.app',
...
function initializeFirebase() {
    ...
    try {
        ...
        firestoreInstance = getFirestore(firebaseApp, 'paradoxe-orbit');

        console.log('[FirebaseClient] Firebase initialized successfully with class-based electron-store persistence.');
        console.log('[FirebaseClient] Firestore instance is targeting the "paradoxe-orbit" database.');
    } catch (error) {
